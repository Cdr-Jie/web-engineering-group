...
<section class="dashboard-section-content">
    ...
    <form action="{{ route('admin.event.update', $event->id) }}" method="POST" enctype="multipart/form-data" class="event-form">
        @csrf
        @method('PUT')
        ...
        <div style="margin-top: 20px;">
            ...
            <a href="{{ route('admin.events') }}" class="btn" style="display: inline-block; text-decoration: none;">Cancel</a>
        </div>
